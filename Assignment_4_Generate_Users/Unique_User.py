...
# lists cannot be type defined because i dont know how to define a webelement or webdriver
def adjust_time(images, links, iframe, search_content: str, keyword: str, preference: str) -> None:
