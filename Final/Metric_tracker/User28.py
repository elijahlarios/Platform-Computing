...
def userAction(driver):
    reward_time = 10
    total_reward_time = userActions("KEYWORD", driver, reward_time, ["batman","game"])
    tag_name = ["img"]
    total_reward_time += userActions("IMAGE", driver, reward_time, [tag_name])
    total_reward_time += userActions("COLOR", driver, reward_time, ['background-color: rgb(223, 207, 190);'])
